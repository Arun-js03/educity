(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  "[project]/node_modules/lodash.throttle/index.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    /**
  ...
  "[project]/node_modules/react-scroll/modules/mixins/passive-event-listeners.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var removePassiveEventListener = (exports.removePassiveEventListener =
      function removePassiveEventListener(target, eventName, listener) {
        target.removeEventListener(eventName, listener);
        attachedListeners.get(eventName).delete(listener.name || eventName);
      });
    var attachedListeners = new Map();
  },
  "[project]/node_modules/react-scroll/modules/mixins/scroll-spy.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _lodash = __turbopack_context__.r(
      "[project]/node_modules/lodash.throttle/index.js [app-client] (ecmascript)",
    );
    var _lodash2 = _interopRequireDefault(_lodash);
    var _passiveEventListeners = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/passive-event-listeners.js [app-client] (ecmascript)",
    );
    ...
    var eventThrottler = function eventThrottler(eventHandler) {
      var throttleAmount =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 66;
    ...
    var scrollSpy = {
      ...
      mount: function mount(scrollSpyContainer, throttle) {
        if (scrollSpyContainer) {
          ...
          return function () {
            (0, _passiveEventListeners.removePassiveEventListener)(
              scrollSpyContainer,
              "scroll",
              eventHandler,
            );
            scrollSpy.scrollSpyContainers.splice(
      ...
      scrollHandler: function scrollHandler(scrollSpyContainer) {
        ...
        callbacks.forEach(function (c) {
          return c(
            scrollSpy.currentPositionX(scrollSpyContainer),
            scrollSpy.currentPositionY(scrollSpyContainer),
          );
        });
      },
      ...
      unmount: function unmount(stateHandler, spyHandler) {
        scrollSpy.scrollSpyContainers.forEach(function (c) {
          return (
            ...
            c.spyCallbacks.indexOf(spyHandler) > -1 &&
            c.spyCallbacks.splice(c.spyCallbacks.indexOf(spyHandler), 1)
          );
        });
        if (
          scrollSpy.spySetState &&
          scrollSpy.spySetState.length &&
          scrollSpy.spySetState.indexOf(stateHandler) > -1
        ) {
  ...
  "[project]/node_modules/react-scroll/modules/mixins/utils.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var getElementOffsetInfoUntil = function getElementOffsetInfoUntil(
      element,
      predicate,
    ) {
    ...
    var scrollOffset = function scrollOffset(c, t, horizontal) {
      if (horizontal) {
        ...
        if (isPositioned(c)) {
          if (t.offsetParent !== c) {
            var isContainerElementOrDocument =
              function isContainerElementOrDocument(e) {
                return e === c || e === document;
              };
            var _getElementOffsetInfo = getElementOffsetInfoUntil(
                t,
  ...
  "[project]/node_modules/react-scroll/modules/mixins/smooth.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/react-scroll/modules/mixins/cancel-events.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
      ...
      subscribe: function subscribe(cancelEvent) {
        return (
          ...
          events.forEach(function (event) {
            return (0, _passiveEventListeners.addPassiveEventListener)(
              document,
              event,
              cancelEvent,
            );
  ...
  "[project]/node_modules/react-scroll/modules/mixins/scroll-events.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/react-scroll/modules/mixins/animate-scroll.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _smooth = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/smooth.js [app-client] (ecmascript)",
    );
    var _smooth2 = _interopRequireDefault(_smooth);
    var _cancelEvents = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/cancel-events.js [app-client] (ecmascript)",
    );
    var _cancelEvents2 = _interopRequireDefault(_cancelEvents);
    var _scrollEvents = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-events.js [app-client] (ecmascript)",
    );
    ...
    var animateScroll = function animateScroll(easing, options, timestamp) {
      ...
      data.currentPosition =
        data.startPosition + Math.ceil(data.delta * data.percent);
      if (
    ...
    var animateTopScroll = function animateTopScroll(
      ...
      options.data.startPosition = options.horizontal
        ? currentPositionX(options)
        : currentPositionY(options);
      ...
      if (options.data.startPosition === options.data.targetPosition) {
        if (_scrollEvents2.default.registered["end"]) {
          _scrollEvents2.default.registered["end"](
            options.data.to,
            options.data.target,
            options.data.currentPosition,
          );
        }
        return;
      }
      options.data.delta = Math.round(
        options.data.targetPosition - options.data.startPosition,
      );
      ...
      if (options && options.delay > 0) {
        options.data.delayTimeout = window.setTimeout(function () {
          if (_scrollEvents2.default.registered["begin"]) {
            _scrollEvents2.default.registered["begin"](
              options.data.to,
              options.data.target,
            );
          }
    ...
    var scrollMore = function scrollMore(toPosition, options) {
      options = proceedOptions(options);
      setContainer(options);
      var currentPosition = options.horizontal
        ? currentPositionX(options)
        : currentPositionY(options);
  ...
  "[project]/node_modules/react-scroll/modules/mixins/scroller.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _utils2 = _interopRequireDefault(_utils);
    var _animateScroll = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/animate-scroll.js [app-client] (ecmascript)",
    );
    ...
    exports.default = {
      ...
      scrollTo: function scrollTo(to, props) {
        ...
        var scrollOffset =
          _utils2.default.scrollOffset(containerElement, target, horizontal) +
          (props.offset || 0);
        /*
  ...
  "[project]/node_modules/react-is/cjs/react-is.development.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/react-is/index.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/next/dist/build/polyfills/object-assign.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/prop-types/lib/ReactPropTypesSecret.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/prop-types/lib/has.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    module.exports = Function.call.bind(Object.prototype.hasOwnProperty);
  },
  "[project]/node_modules/prop-types/checkPropTypes.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/prop-types/factoryWithTypeCheckers.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/react-scroll/modules/mixins/scroll-hash.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/react-scroll/modules/mixins/scroll-link.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _scrollSpy = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-spy.js [app-client] (ecmascript)",
    );
    var _scrollSpy2 = _interopRequireDefault(_scrollSpy);
    var _scroller = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroller.js [app-client] (ecmascript)",
    );
    var _scroller2 = _interopRequireDefault(_scroller);
    var _propTypes = __turbopack_context__.r(
      "[project]/node_modules/prop-types/index.js [app-client] (ecmascript)",
    );
    var _propTypes2 = _interopRequireDefault(_propTypes);
    var _scrollHash = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-hash.js [app-client] (ecmascript)",
    );
            ...
            value: function componentDidMount() {
              if (this.props.spy || this.props.hashSpy) {
                ...
                if (!_scrollSpy2.default.isMounted(scrollSpyContainer)) {
                  var fn = _scrollSpy2.default.mount(
                    scrollSpyContainer,
        ...
        this.spyHandler = function (x, y) {
          ...
          if (isOutside) {
            ...
            if (_this2.props.hashSpy && _scrollHash2.default.getHash() === to) {
              var _props$saveHashHistor = _this2.props.saveHashHistory,
                saveHashHistory =
                  _props$saveHashHistor === undefined
                    ? false
                    : _props$saveHashHistor;
          ...
          if (
            ...
            var _props$saveHashHistor2 = _this2.props.saveHashHistory,
              _saveHashHistory =
                _props$saveHashHistor2 === undefined
                  ? false
                  : _props$saveHashHistor2;
            _this2.props.hashSpy &&
              _scrollHash2.default.changeHash(to, _saveHashHistory);
            if (_this2.props.spy) {
              _this2.setState({
                active: true,
              });
  ...
  "[project]/node_modules/react-scroll/modules/components/Link.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _react2 = _interopRequireDefault(_react);
    var _scrollLink = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-link.js [app-client] (ecmascript)",
    );
  ...
  "[project]/node_modules/react-scroll/modules/components/Button.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
  ...
  "[project]/node_modules/react-scroll/modules/mixins/scroll-element.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _react2 = _interopRequireDefault(_react);
    var _reactDom = __turbopack_context__.r(
  ...
  "[project]/node_modules/react-scroll/modules/components/Element.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    var _react2 = _interopRequireDefault(_react);
    var _scrollElement = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-element.js [app-client] (ecmascript)",
    );
    ...
    var ElementWrapper = (function (_React$Component) {
      ...
      function ElementWrapper() {
        ...
        return _possibleConstructorReturn(
          this,
          (
            ElementWrapper.__proto__ || Object.getPrototypeOf(ElementWrapper)
          ).apply(this, arguments),
        );
      }
  ...
  "[project]/node_modules/react-scroll/modules/mixins/Helpers.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";

    /* DEPRECATED */ var _extends =
      Object.assign ||
      function (target) {
        for (var i = 1; i < arguments.length; i++) {
          var source = arguments[i];
    ...
    var ReactDOM = __turbopack_context__.r(
      "[project]/node_modules/next/dist/compiled/react-dom/index.js [app-client] (ecmascript)",
    );
    var utils = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/utils.js [app-client] (ecmascript)",
    );
    var scrollSpy = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-spy.js [app-client] (ecmascript)",
    );
    var defaultScroller = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroller.js [app-client] (ecmascript)",
    );
    var PropTypes = __turbopack_context__.r(
      "[project]/node_modules/prop-types/index.js [app-client] (ecmascript)",
    );
    var scrollHash = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/scroll-hash.js [app-client] (ecmascript)",
    );
    var protoTypes = {
  ...
  "[project]/node_modules/react-scroll/modules/index.js [app-client] (ecmascript)",
  (__turbopack_context__, module, exports) => {
    "use strict";
    ...
    exports.Helpers =
      ...
      exports.Link =
        undefined;
    var _Link = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/components/Link.js [app-client] (ecmascript)",
    );
    var _Link2 = _interopRequireDefault(_Link);
    var _Button = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/components/Button.js [app-client] (ecmascript)",
    );
    var _Button2 = _interopRequireDefault(_Button);
    var _Element = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/components/Element.js [app-client] (ecmascript)",
    );
    ...
    var _scrollElement2 = _interopRequireDefault(_scrollElement);
    var _Helpers = __turbopack_context__.r(
      "[project]/node_modules/react-scroll/modules/mixins/Helpers.js [app-client] (ecmascript)",
    );
